...
import com.hjq.demo.ui.fragment.NotepadFragment;
import com.hjq.demo.ui.fragment.TimerFragment;
...
public final class HomeActivity extends AppActivity
    ...
    protected void initView() {
        ...
        mNavigationAdapter.addItem(new NavigationAdapter.MenuItem("事项",
                ContextCompat.getDrawable(this, R.drawable.home_found_selector)));
        mNavigationAdapter.addItem(new NavigationAdapter.MenuItem("专注",
                ContextCompat.getDrawable(this, R.drawable.home_found_selector)));
        mNavigationAdapter.addItem(new NavigationAdapter.MenuItem("规划",
    ...
    protected void initData() {
        ...
        mPagerAdapter.addFragment(NotepadFragment.newInstance());
        mPagerAdapter.addFragment(TimerFragment.newInstance());
